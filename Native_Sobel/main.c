...
int main(int argc, char** argv)
{
	...
	char * file_output_RGB = "image.rgb";
	...
	output_gray_scale_image(INTERMEDIATE_OUTPUT, grayImage, gray_size,	str_width, str_height, STRING_BUFFER_SIZE, "img_gray.png");
	...
	output_gradient(INTERMEDIATE_OUTPUT, sobel_h_res, gray_size, str_width,	str_height, STRING_BUFFER_SIZE, "sobel_horiz_grad.png");
	...
	output_gradient(INTERMEDIATE_OUTPUT, sobel_v_res, gray_size, str_width,	str_height, STRING_BUFFER_SIZE, "sobel_vert_grad.png");
	...
	write_file("sobel_countour.gray", countour_img, gray_size);
	...
	if(argc > 2)
	{
		output_gradient(true, countour_img, gray_size, str_width, str_height, STRING_BUFFER_SIZE, argv[2]);		
	}
